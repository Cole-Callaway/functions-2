...
// CODE HERE 
const first = (arr, firstName) => firstName(arr[0])
...
// CODE HERE
const last = (arr, lastName) => lastName(arr[arr.length - 1])
...
// CODE HERE 
const each = (arr, call) => arr.forEach((element, i) => call(element, i)) 
...
*/
const addNumber = addingFactory(11)
